...
export const fetchSushiFirestore = createAsyncThunk<TSushiItem[], FetchSushiArgs,  { rejectValue: string }> (
  ...
  async ({categoriesId, currentPage, limitValue }, thunkApi) => {
    try {
      ...
      if (currentPage > 1 && lastVisible) {
        sushiQuery = query(sushiQuery, startAfter(lastVisible), limit(limitValue));
      } else {
